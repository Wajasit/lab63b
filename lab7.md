...
2. เราใช้ต้นแบบคำสั่งจากการทดลองที่3 ในการนำมาปรับปรุงใช้กับการทดลองนี้ โดยเราจะกำหนดเวลาในการเปิดปิดLEDแต่ละสีด้วยโค้ดดังต่อไปนี้
  #include <Arduino.h>
	#include <ESP8266WiFi.h>
        ...
        {
          cnt++;
3. กำหนดให้ช่วงcnt ตั้งแต่ 0 ถึง 3600*24*10 LED สีแดงจะสว่าง ซึ่งที่เรากำหนดให้สว่างในช่วงนี้เพราะว่าเราต้องการจะเร่งการเจริญเติบโตของเมล็ดพืช ซึ่งเมล็ดพืชจะถูกกระตุ้นด้วยแสงสีแดงนี้ให้เกิดการเจริญเติบโต
